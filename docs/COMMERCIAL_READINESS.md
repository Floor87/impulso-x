...
| -------------- | ----------- | ------------------------------------------------------------------- | ------------------------------------ |
| Release        | En progreso | PR #9 integrada, checks verdes y environment `production` protegido | Ejecucion de GitHub Actions          |
| Staging        | Bloqueado   | Proyecto o branch de Supabase separado de produccion                | Referencia del proyecto y prueba RLS |
| Privacidad     | Pendiente   | Aviso de privacidad revisado para Argentina y mercados objetivo     | Version publicada y fecha            |
| Terminos       | Pendiente   | Terminos de uso, cancelacion y limitaciones del servicio            | Version publicada y fecha            |
| Cuenta         | Pendiente   | Exportacion y eliminacion de cuenta y datos desde la app            | E2E y registro de borrado            |
| Sincronizacion | Pendiente   | Control de versiones que impida sobrescritura entre dispositivos    | Pruebas de conflicto                 |
